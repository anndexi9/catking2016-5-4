...
<section class="aside2">
  ...
  <table><tr><td colspan="2"><h1>商品詳細</h1></td></tr>
  <tr>
  <td rowspan="7" ><img src="./img/Catkingfoto/${item.id}.jpg" style="width:70%; height:70%;"></td></tr>
  <tr><td>商品番号:<b>${item.id}</b><br><br></td></tr>
  <tr><td>商品名:<b>${item.name}</b><br><br></td></tr>
  <tr><td>価格（税込）:<b>${item.price } 円</b><br><br></td></tr>
  <tr><td>メーカー：${item.brand}<br><br></td></tr>
  <tr><td>種類：${item.category}＞${item.sub_cat}<br><br></td></tr>
  <tr><td>個数:<input type ="text" name="quantity" size="1" value="1">個<br><br>
  <input type ="submit" value ="カートに追加">
   </td></tr>
   <tr><td colspan="2">商品説明:<br><br>
   ${item.memo}</td></tr>
   </table>
   <br><br><br>
